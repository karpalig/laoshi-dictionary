    ...
    var body: some View {
        NavigationView {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        GlassButton("Сохранить", systemImage: "checkmark.circle.fill", color: .cyan) {
                            viewModel.updateDictionary(dictionary, name: name, description: description, color: selectedColor)
                            dismiss()
                        }
            ...
            .onAppear {
                ...
                description = dictionary.descriptionText ?? ""
                selectedColor = dictionary.color ?? "cyan"
            }
        }
    }
